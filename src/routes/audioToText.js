...
/**
 * POST /audio-to-text
 * Body: { provider, audio, mimeType?, model?, language?, prompt?, conversationId?, userMessage? }
 ...
 *
 * When conversationId is provided, the user message and transcription result
