...
const MODELS = {
    ...
    GPT_5_2: {
        ...
        arena: { text: 1479, code: 1472, vision: 1271, document: 1412, search: 1219 },
        pricing: { inputPerMillion: 0.875, cachedInputPerMillion: 0.0875, outputPerMillion: 7.0, webSearchPer1kCalls: 10.0 },
    ...
    GPT_5_MINI: {
        ...
        provider: PROVIDERS.OPENAI,
        defaultTemperature: 1.0,
        pricing: { inputPerMillion: 0.125, cachedInputPerMillion: 0.0125, outputPerMillion: 1.0, webSearchPer1kCalls: 10.0 },
        maxInputTokens: 400_000,
        maxOutputTokens: 128_000,
        inputTypes: [TYPES.TEXT, TYPES.IMAGE],
        outputTypes: [TYPES.TEXT],
    ...
    GPT_5_NANO: {
        ...
        provider: PROVIDERS.OPENAI,
        defaultTemperature: 1.0,
        pricing: { inputPerMillion: 0.025, cachedInputPerMillion: 0.0025, outputPerMillion: 0.20, webSearchPer1kCalls: 25.0 },
        maxInputTokens: 400_000,
        maxOutputTokens: 128_000,
        inputTypes: [TYPES.TEXT, TYPES.IMAGE],
        outputTypes: [TYPES.TEXT],
    ...
    GPT_41_MINI: {
        ...
        provider: PROVIDERS.OPENAI,
        listed: false,
        pricing: { inputPerMillion: 0.40, cachedInputPerMillion: 0.10, outputPerMillion: 1.60 },
    ...
    GPT_41_NANO: {
        ...
        provider: PROVIDERS.OPENAI,
        listed: false,
        pricing: { inputPerMillion: 0.10, cachedInputPerMillion: 0.025, outputPerMillion: 0.40 },
        maxInputTokens: 1_047_576,
        maxOutputTokens: 32_768,
        inputTypes: [TYPES.TEXT, TYPES.IMAGE],
        outputTypes: [TYPES.TEXT],
    ...
    GPT_4O: {
        ...
        provider: PROVIDERS.OPENAI,
        listed: false,
        pricing: { inputPerMillion: 2.50, cachedInputPerMillion: 1.25, outputPerMillion: 10.0 },
    ...
    GPT_54: {
        ...
        defaultTemperature: 1.0,
        arena: { text: 1479 },
        pricing: { inputPerMillion: 1.25, cachedInputPerMillion: 0.13, outputPerMillion: 7.50, inputOver272kPerMillion: 2.50, outputOver272kPerMillion: 11.25, webSearchPer1kCalls: 10.0 },
    ...
    GPT_54_PRO: {
        ...
        provider: PROVIDERS.OPENAI,
        defaultTemperature: 1.0,
        pricing: { inputPerMillion: 15.0, outputPerMillion: 90.0, inputOver272kPerMillion: 30.0, outputOver272kPerMillion: 135.0, webSearchPer1kCalls: 10.0 },
        maxInputTokens: 1_050_000,
        maxOutputTokens: 128_000,
        inputTypes: [TYPES.TEXT, TYPES.IMAGE],
        outputTypes: [TYPES.TEXT],
    ...
    GEMINI_3_FLASH: {
        ...
        default: true,
        defaultTemperature: 1.0,
        arena: { text: 1473, code: 1442, vision: 1276, document: 1422, search: 1218 },
    ...
    GEMINI_3_PRO: {
        ...
        provider: PROVIDERS.GOOGLE,
        defaultTemperature: 1.0,
        arena: { text: 1485, code: 1442, vision: 1288, document: 1444, search: 1214 },
    ...
    GPT_4O_MINI_TTS: {
        ...
        provider: PROVIDERS.OPENAI,
        default: true,
        pricing: { inputPerMillion: 0.60, audioOutputPerMillion: 12.0, perMinute: 0.015 },
        inputTypes: [TYPES.TEXT],
    ...
    GPT_4O_TRANSCRIBE: {
        ...
        provider: PROVIDERS.OPENAI,
        default: true,
        pricing: { audioInputPerMillion: 2.50, outputPerMillion: 10.0, perMinute: 0.006 },
    ...
    GPT_4O_MINI_TRANSCRIBE: {
        ...
        provider: PROVIDERS.OPENAI,
        pricing: { audioInputPerMillion: 1.25, outputPerMillion: 5.0, perMinute: 0.003 },
        inputTypes: [TYPES.AUDIO],
        outputTypes: [TYPES.TEXT],
    },
    WHISPER_1: {
