...
const MODELS = {
    ...
    GPT_IMAGE_15: {
        ...
        pricing: { inputPerMillion: 5.0, outputPerMillion: 40.0, imageOutputPerMillion: 167.0 },
        maxInputTokens: 32_768,
    ...
    GPT_4O_TRANSCRIBE: {
        ...
        provider: PROVIDERS.OPENAI,
        default: true,
        pricing: { audioInputPerMillion: 2.5, outputPerMillion: 10.0 },
    ...
    GPT_4O_MINI_TRANSCRIBE: {
        ...
        provider: PROVIDERS.OPENAI,
        pricing: { audioInputPerMillion: 1.25, outputPerMillion: 5.0 },
        inputTypes: [TYPES.AUDIO],
        outputTypes: [TYPES.TEXT],
    },
    WHISPER_1: {
