...
export default {
    ...
    schema: {
        name: "ask_user_question",
        description: "Ask the user one or more questions and wait for their responses before continuing. " +
        ...
        if (questions && Array.isArray(questions) && questions.length > 0) {
            ...
            for (const q of questions) {
                if (!q.question || typeof q.question !== "string") {
                    return {
                        error: "Each question in the 'questions' array must have a non-empty 'question' string",
                    };
                }
