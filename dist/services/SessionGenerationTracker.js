...
const SessionGenerationTracker = {
    ...
    update(requestId, { outputTokens, inputTokens, ttft } = {}) {
        ...
        if (!entry.firstTokenTime)
            entry.firstTokenTime = now;
    ...
    complete(requestId) {
        ...
        if (sessionSet) {
            ...
            if (sessionSet.size === 0)
                sessionIndex.delete(entry.agentSessionId);
        }
    },
    /**
...
//# sourceMappingURL=SessionGenerationTracker.js.map