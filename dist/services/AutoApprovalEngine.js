...
export default class AutoApprovalEngine {
    ...
    checkBatch(toolCalls) {
        ...
        if (needsApproval.length > 0) {
            logger.info(`[AutoApproval] ${autoApproved.length} auto-approved, ${needsApproval.length} need approval: ${needsApproval.map((t) => t.name).join(", ")}`);
        }
...
//# sourceMappingURL=AutoApprovalEngine.js.map