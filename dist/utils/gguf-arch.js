 ...
 */
export function estimateMemory({ sizeBytes, archParams, gpuLayers, contextLength, offloadKvCache = true, flashAttention = true, vision = false, gpuTotalGiB, gpuBaselineGiB = 0, }) {
...
//# sourceMappingURL=gguf-arch.js.map